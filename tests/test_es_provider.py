...
class EsProviderTests(unittest.TestCase):
    ...
    def test_discovery_country_es_returns_daily_only_elements(self) -> None:
        ...
        self.assertEqual(
            ...
            ['tmed', 'tmax', 'tmin', 'prec', 'velmedia', 'sol'],
        )
    ...
    def test_es_queries_accept_canonical_and_raw_codes(self) -> None:
        ...
        raw_query = ObservationQuery(
            ...
            start_date='2024-03-01',
            end_date='2024-03-02',
            elements=['tmed', 'velmedia'],
        )
        self.assertEqual(daily_query.elements, ['tmed', 'velmedia'])
        self.assertEqual(raw_query.elements, ['tmed', 'velmedia'])
    ...
    def test_es_daily_download_normalizes_output_from_fixtures(self) -> None:
        ...
        query = ObservationQuery(
            ...
            start_date='2024-03-01',
            end_date='2024-03-02',
            elements=['tas_mean', 'tas_max', 'tas_min', 'precipitation', 'wind_speed', 'sunshine_duration'],
        )
        ...
        self.assertEqual(sorted(observations['element'].unique().tolist()), ['precipitation', 'sunshine_duration', 'tas_max', 'tas_mean', 'tas_min', 'wind_speed'])
        self.assertEqual(sorted(observations['element_raw'].unique().tolist()), ['prec', 'sol', 'tmax', 'tmed', 'tmin', 'velmedia'])
