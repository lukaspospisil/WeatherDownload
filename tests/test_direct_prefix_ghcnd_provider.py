...
COUNTRY_SPECS = {
    ...
    'CY': {
        'station_core': 'CY000000001',
        'station_prcp_only': 'CY000000002',
        'station_unsupported': 'CY000000003',
        'fixture_path': Path('tests/data/sample_ghcnd_CY000000001.dly'),
    ...
    'GB': {
        'station_core': 'GB000000001',
        'station_prcp_only': 'GB000000002',
        'station_unsupported': 'GB000000003',
    ...
    'MT': {
        'station_core': 'MT000000001',
        'station_prcp_only': 'MT000000002',
        'station_unsupported': 'MT000000003',
        'fixture_path': Path('tests/data/sample_ghcnd_MT000000001.dly'),
    ...
    'MD': {
        'station_core': 'MD000000001',
        'station_prcp_only': 'MD000000002',
        'station_unsupported': 'MD000000003',
        'fixture_path': Path('tests/data/sample_ghcnd_MD000000001.dly'),
...
GHCND_ONLY_COUNTRIES = ('AL', 'BG', 'CY', 'GR', 'HR', 'IT', 'MD', 'MK', 'MT', 'NZ')
