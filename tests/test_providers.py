...
class ProviderTests(unittest.TestCase):
    def test_supported_countries_and_normalization(self) -> None:
        self.assertEqual(list_supported_countries(), ['AT', 'BE', 'BG', 'CA', 'CH', 'CZ', 'DE', 'DK', 'EE', 'ES', 'FI', 'FR', 'GB', 'GR', 'HR', 'HU', 'IE', 'IS', 'IT', 'LT', 'LU', 'LV', 'MT', 'MX', 'NL', 'NO', 'NZ', 'PL', 'PT', 'RO', 'SE', 'SI', 'SK', 'US'])
    ...
    def test_discovery_direct_prefix_ghcnd_countries_include_conservative_core_without_evap(self) -> None:
        for country in ['BG', 'GR', 'HR', 'IS', 'IT', 'MT', 'NZ']:
            with self.subTest(country=country):
