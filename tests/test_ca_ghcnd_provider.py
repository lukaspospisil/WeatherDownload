...
class CanadaGhcndProviderTests(unittest.TestCase):
    ...
    def test_provider_capability_metadata_is_explicit(self) -> None:
        ...
        self.assertIn('1hour', provider.supported_resolutions)
        self.assertIn('tas_mean', provider.supported_canonical_elements)
        self.assertIn('tas_max', provider.supported_canonical_elements)
        self.assertIn('tas_min', provider.supported_canonical_elements)
        self.assertIn('precipitation', provider.supported_canonical_elements)
        self.assertIn('snow_depth', provider.supported_canonical_elements)
        self.assertIn('relative_humidity', provider.supported_canonical_elements)
        self.assertIn('wind_speed', provider.supported_canonical_elements)
        self.assertIn('pressure', provider.supported_canonical_elements)
        self.assertNotIn('open_water_evaporation', provider.supported_canonical_elements)
