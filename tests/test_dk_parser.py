...
from weatherdownload.dk_registry import DK_DAILY_PARAMETER_METADATA, get_dataset_spec
...
class DenmarkParserTests(unittest.TestCase):
    ...
    def test_normalize_dk_observation_metadata_uses_supported_parameter_ids(self) -> None:
