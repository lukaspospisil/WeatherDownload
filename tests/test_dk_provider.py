...
class DenmarkProviderTests(unittest.TestCase):
    ...
    def test_discovery_country_dk_returns_canonical_and_raw_elements(self) -> None:
        ...
        self.assertEqual(
            list_supported_elements(country='DK', dataset_scope='historical', resolution='daily', provider_raw=True),
            ['mean_temp', 'mean_daily_max_temp', 'mean_daily_min_temp', 'acc_precip', 'mean_wind_speed', 'mean_relative_hum', 'mean_pressure', 'bright_sunshine'],
        )
