...
class DownloadHourlyExampleTests(unittest.TestCase):
    ...
    def test_main_uses_shared_at_query_shape(self) -> None:
        sample = pd.DataFrame([{'station_id': '1', 'gh_id': None, 'element': 'tas_mean', 'element_raw': 'tl', 'timestamp': '2024-01-01T00:00:00Z', 'value': 2.1, 'flag': '20', 'quality': None, 'provider': 'historical', 'resolution': '1hour'}])
        buffer = io.StringIO()
    ...
    def test_main_uses_shared_be_query_shape(self) -> None:
        sample = pd.DataFrame([{'station_id': '6414', 'gh_id': None, 'element': 'tas_mean', 'element_raw': 'temp_dry_shelter_avg', 'timestamp': '2024-01-01T01:00:00Z', 'value': 4.1, 'flag': '{"validated":{"TEMP_DRY_SHELTER_AVG":true}}', 'quality': None, 'provider': 'historical', 'resolution': '1hour'}])
        buffer = io.StringIO()
        with patch.object(download_hourly, 'download_observations', return_value=sample) as download_mock:
    ...
    def test_main_uses_shared_ch_query_shape(self) -> None:
        sample = pd.DataFrame([{'station_id': 'AIG', 'gh_id': '0-20000-0-06712', 'element': 'tas_mean', 'element_raw': 'tre200h0', 'timestamp': '2025-12-31T23:00:00Z', 'value': -3.4, 'flag': None, 'quality': None, 'provider': 'historical', 'resolution': '1hour'}])
        buffer = io.StringIO()
        with patch.object(download_hourly, 'download_observations', return_value=sample) as download_mock:
    ...
    def test_main_uses_shared_dk_query_shape(self) -> None:
        sample = pd.DataFrame([{'station_id': '06180', 'gh_id': None, 'element': 'tas_mean', 'element_raw': 'mean_temp', 'timestamp': '2024-01-01T01:00:00Z', 'value': 2.8, 'flag': '{"qcStatus":"manual","validity":true}', 'quality': None, 'provider': 'historical', 'resolution': '1hour'}])
        buffer = io.StringIO()
        with patch.object(download_hourly, 'download_observations', return_value=sample) as download_mock:
    ...
    def test_main_uses_shared_hu_query_shape(self) -> None:
        sample = pd.DataFrame([{'station_id': '13704', 'gh_id': None, 'element': 'tas_mean', 'element_raw': 'ta', 'timestamp': '2026-01-01T00:00:00Z', 'value': 1.2, 'flag': None, 'quality': None, 'provider': 'historical', 'resolution': '1hour'}])
        buffer = io.StringIO()
        with patch.object(download_hourly, 'download_observations', return_value=sample) as download_mock:
    ...
    def test_main_uses_shared_se_query_shape(self) -> None:
        sample = pd.DataFrame([{'station_id': '98230', 'gh_id': None, 'element': 'tas_mean', 'element_raw': '1', 'timestamp': '2012-11-29T11:00:00Z', 'value': 3.1, 'flag': 'G', 'quality': None, 'provider': 'historical', 'resolution': '1hour'}])
        buffer = io.StringIO()
        with patch.object(download_hourly, 'download_observations', return_value=sample) as download_mock:
