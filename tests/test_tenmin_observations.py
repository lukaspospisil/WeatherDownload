...
class TenMinObservationTests(unittest.TestCase):
    def test_query_to_download_mapping(self) -> None:
        query = ObservationQuery(provider='historical_csv', resolution='10min', station_ids=['0-20000-0-11406'], start='2024-01-01T00:00:00Z', end='2024-01-01T00:20:00Z', elements=['tas_mean'])
    ...
    def test_tenmin_mapping_supports_multiple_groups(self) -> None:
        query = ObservationQuery(provider='historical_csv', resolution='10min', station_ids=['0-20000-0-11406'], start='2024-01-01T00:00:00Z', end='2024-01-01T00:20:00Z', elements=['soil_temperature_10cm', 'sunshine_duration'])
        targets = build_tenmin_download_targets(query)
    ...
    def test_tenmin_all_history_builds_targets_from_directory_listing(self) -> None:
        ...
        query = ObservationQuery(provider='historical_csv', resolution='10min', station_ids=['0-20000-0-11406'], all_history=True, elements=['tas_mean'])
    ...
    def test_normalized_tenmin_supports_soil_temperature_element(self) -> None:
        query = ObservationQuery(provider='historical_csv', resolution='10min', station_ids=['0-20000-0-11406'], start='2024-01-01T00:00:00Z', end='2024-01-01T00:20:00Z', elements=['soil_temperature_10cm'])
    ...
    def test_normalized_tenmin_supports_sunshine_element(self) -> None:
        query = ObservationQuery(provider='historical_csv', resolution='10min', station_ids=['0-20000-0-11406'], start='2024-01-01T00:00:00Z', end='2024-01-01T00:20:00Z', elements=['sunshine_duration'])
