...
- Provider model and terminology: [Provider Model](providers.md)
- Current country/provider/resolution/element coverage: [Supported Capabilities](supported_capabilities.md)
