...
| --- | --- | --- | --- | --- | --- |
| `AT` | `ghcnd` | `daily` | `tas_max`, `tas_min`, `precipitation` | NOAA GHCN-Daily | Mapped-prefix GHCN wrapper using raw GHCN station ids with prefix AU; no EVAP/open_water_evaporation. |
...
| `CH` | `ghcnd` | `daily` | `tas_max`, `tas_min`, `precipitation` | NOAA GHCN-Daily | Mapped-prefix GHCN wrapper using raw GHCN station ids with prefix SZ; no EVAP/open_water_evaporation. |
...
| `DE` | `ghcnd` | `daily` | `tas_max`, `tas_min`, `precipitation` | NOAA GHCN-Daily | Mapped-prefix GHCN wrapper using raw GHCN station ids with prefix GM; no EVAP/open_water_evaporation. |
...
| `DK` | `ghcnd` | `daily` | `tas_max`, `tas_min`, `precipitation` | NOAA GHCN-Daily | Mapped-prefix GHCN wrapper using raw GHCN station ids with prefix DA; no EVAP/open_water_evaporation. |
...
| `SE` | `ghcnd` | `daily` | `tas_max`, `tas_min`, `precipitation` | NOAA GHCN-Daily | Mapped-prefix GHCN wrapper using raw GHCN station ids with prefix SW; no EVAP/open_water_evaporation. |
...
| `SK` | `ghcnd` | `daily` | `tas_max`, `tas_min`, `precipitation` | NOAA GHCN-Daily | Mapped-prefix GHCN wrapper using raw GHCN station ids with prefix LO; no EVAP/open_water_evaporation. |
