...
| `FI` | `fmi` | `1hour` | `tas_mean`, `wind_speed` | Finnish Meteorological Institute (FMI) Open Data WFS hourly observations | Conservative first slice via WFS timevaluepair; station_id is FMI fmisid; units may be absent inline in the XML payload. |
