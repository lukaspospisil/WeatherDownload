...
- station metadata from the implemented official station list still expose the canonical 5-character station code and station name, but not coordinates, elevation, or validity range
