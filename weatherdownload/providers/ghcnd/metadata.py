...
from .registry import GHCND_INVENTORY_URL, GHCND_STATIONS_URL, GhcndDatasetSpec


def read_station_metadata_ghcnd(
...
def read_station_observation_metadata_ghcnd(
    source_url: str | None = None,
    timeout: int = 60,
    *,
    spec: GhcndDatasetSpec,
