...
from .metadata import (
    ...
    read_station_metadata_meteo_lt,
    read_station_observation_metadata_ghcnd,
    read_station_observation_metadata_meteo_lt,
)
from .observations import download_daily_observations_ghcnd, download_daily_observations_meteo_lt
...
def _download_national_observations(*args, **kwargs):
    return download_daily_observations_meteo_lt(*args, **kwargs)


_read_station_metadata = build_mixed_station_metadata_reader(
    read_national_station_metadata=read_station_metadata_meteo_lt,
...
_read_station_observation_metadata = build_mixed_station_observation_metadata_reader(
    read_national_station_observation_metadata=read_station_observation_metadata_meteo_lt,
...
PROVIDER = WeatherProvider(
    country_code='LT',
    name='LHMT Meteo.lt daily + NOAA GHCN-Daily',
    ...
    supported_country_codes=('LT',),
    supported_providers=('ghcnd', 'meteo_lt'),
