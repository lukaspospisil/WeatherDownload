...
from .metadata import (
    read_station_metadata_anm,
    read_station_metadata_ghcnd,
    read_station_observation_metadata_anm,
    read_station_observation_metadata_ghcnd,
)
from .observations import download_daily_observations_anm, download_daily_observations_ghcnd
...
def _download_national_observations(*args, **kwargs):
    return download_daily_observations_anm(*args, **kwargs)


_read_station_metadata = build_mixed_station_metadata_reader(
    read_national_station_metadata=read_station_metadata_anm,
...
_read_station_observation_metadata = build_mixed_station_observation_metadata_reader(
    read_national_station_observation_metadata=read_station_observation_metadata_anm,
...
PROVIDER = WeatherProvider(
    country_code='RO',
    name='ANM INSPIRE daily + NOAA GHCN-Daily',
    ...
    supported_country_codes=('RO',),
    supported_providers=('anm', 'ghcnd'),
