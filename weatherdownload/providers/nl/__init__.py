...
from .metadata import (
    ...
    read_station_metadata_knmi,
    read_station_observation_metadata_ghcnd,
    read_station_observation_metadata_knmi,
)
from .observations import download_daily_observations_ghcnd, download_daily_observations_knmi
...
def _download_national_observations(*args, **kwargs):
    return download_daily_observations_knmi(*args, **kwargs)


_read_station_metadata = build_mixed_station_metadata_reader(
    read_national_station_metadata=read_station_metadata_knmi,
...
_read_station_observation_metadata = build_mixed_station_observation_metadata_reader(
    read_national_station_observation_metadata=read_station_observation_metadata_knmi,
...
PROVIDER = WeatherProvider(
    country_code='NL',
    name='KNMI daily + NOAA GHCN-Daily',
    ...
    supported_providers=('ghcnd', 'knmi'),
