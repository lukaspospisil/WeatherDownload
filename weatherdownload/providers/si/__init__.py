...
from .metadata import (
    read_station_metadata_arso,
    read_station_metadata_ghcnd,
    read_station_observation_metadata_arso,
    read_station_observation_metadata_ghcnd,
)
from .observations import download_daily_observations_arso, download_daily_observations_ghcnd
...
def _download_national_observations(*args, **kwargs):
    return download_daily_observations_arso(*args, **kwargs)


_read_station_metadata = build_mixed_station_metadata_reader(
    read_national_station_metadata=read_station_metadata_arso,
...
_read_station_observation_metadata = build_mixed_station_observation_metadata_reader(
    read_national_station_observation_metadata=read_station_observation_metadata_arso,
...
PROVIDER = WeatherProvider(
    country_code='SI',
    name='ARSO daily + NOAA GHCN-Daily',
    ...
    supported_country_codes=('SI',),
    supported_providers=('arso', 'ghcnd'),
