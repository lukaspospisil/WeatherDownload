...
from ..hu_metadata import read_station_metadata_hu, read_station_observation_metadata_hu
from ..hu_registry import get_dataset_spec, list_dataset_specs, list_implemented_dataset_specs
...
PROVIDER = WeatherProvider(
    ...
    supported_dataset_scopes=('historical', 'historical_wind'),
