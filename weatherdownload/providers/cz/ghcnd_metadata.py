...
from .ghcnd_registry import get_dataset_spec


read_station_metadata_ghcnd = build_station_metadata_reader(country_prefix='EZ', get_dataset_spec=get_dataset_spec)
