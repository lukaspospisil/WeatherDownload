...
from .daily import download_daily_observations_ilmateenistus
from .metadata import (
    read_station_metadata_ghcnd,
    read_station_metadata_ilmateenistus,
    read_station_observation_metadata_ghcnd,
    read_station_observation_metadata_ilmateenistus,
)
...
def _download_national_observations(*args, **kwargs):
    return download_daily_observations_ilmateenistus(*args, **kwargs)


_read_station_metadata = build_mixed_station_metadata_reader(
    read_national_station_metadata=read_station_metadata_ilmateenistus,
...
_read_station_observation_metadata = build_mixed_station_observation_metadata_reader(
    read_national_station_observation_metadata=read_station_observation_metadata_ilmateenistus,
...
PROVIDER = WeatherProvider(
    country_code='EE',
    name='Estonian Environment Agency daily + NOAA GHCN-Daily',
    ...
    supported_country_codes=('EE',),
    supported_providers=('ghcnd', 'ilmateenistus'),
