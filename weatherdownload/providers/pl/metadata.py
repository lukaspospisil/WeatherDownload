...
from .parser import normalize_pl_observation_metadata, parse_pl_station_metadata_csv, read_text_from_source
from .registry import PL_OBSERVATION_PARAMETER_METADATA, get_dataset_spec
...
def read_station_observation_metadata_pl(source_url: str | None = None, timeout: int = 60) -> pd.DataFrame:
    ...
    specs_and_metadata = [
        (get_dataset_spec('historical', 'daily'), PL_OBSERVATION_PARAMETER_METADATA),
    ]
