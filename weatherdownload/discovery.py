...
def list_supported_elements(
    ...
    if resolution is not None:
        ...
        return sorted({element for spec in matches for element in spec.supported_elements})
    if dataset_scope is not None:
        ...
        return sorted({element for spec in matches for element in spec.supported_elements})
    return sorted({element for spec in specs for element in spec.supported_elements})
