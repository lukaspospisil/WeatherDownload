...
from .hu_registry import HU_DAILY_PARAMETER_METADATA, get_dataset_spec
...
def read_station_observation_metadata_hu(source_url: str | None = None, timeout: int = 60) -> pd.DataFrame:
    ...
    return normalize_hu_observation_metadata(stations, get_dataset_spec('historical', 'daily'), HU_DAILY_PARAMETER_METADATA)
