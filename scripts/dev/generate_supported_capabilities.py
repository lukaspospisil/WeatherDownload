...
NOTES: dict[tuple[str, str, str], str] = {
    ...
    ('NL', 'knmi', 'daily'): 'Public daggegevens daily CSV path. TG/TX/TN, RH, FG, PG, and SQ are converted from source tenths to canonical units; RH=-1 and SQ=-1 are normalized to observed 0.0 for below-threshold trace values; Q is converted from J/cm^2 to canonical MJ m^-2 via value * 0.01; observed vapour_pressure is intentionally not exposed; compatible with shared FAO allow-derived only through tas_mean plus relative_humidity.',
