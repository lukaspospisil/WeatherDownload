...
NOTES: dict[tuple[str, str, str], str] = {
    ...
    ('AT', 'ghcnd', 'daily'): 'Mapped-prefix GHCN wrapper using raw GHCN station ids with prefix AU; no EVAP/open_water_evaporation.',
    ...
    ('CH', 'ghcnd', 'daily'): 'Mapped-prefix GHCN wrapper using raw GHCN station ids with prefix SZ; no EVAP/open_water_evaporation.',
    ...
    ('CZ', 'ghcnd', 'daily'): 'Mapped-prefix GHCN wrapper using raw GHCN station ids with prefix EZ; no EVAP/open_water_evaporation.',
    ...
    ('DE', 'ghcnd', 'daily'): 'Mapped-prefix GHCN wrapper using raw GHCN station ids with prefix GM; no EVAP/open_water_evaporation.',
    ...
    ('DK', 'ghcnd', 'daily'): 'Mapped-prefix GHCN wrapper using raw GHCN station ids with prefix DA; no EVAP/open_water_evaporation.',
    ('FI', 'ghcnd', 'daily'): 'Thin shared GHCN wrapper; raw GHCN station ids; no EVAP/open_water_evaporation.',
    ('FR', 'ghcnd', 'daily'): 'Thin shared GHCN wrapper; raw GHCN station ids; no EVAP/open_water_evaporation.',
    ...
    ('IT', 'ghcnd', 'daily'): 'Thin shared GHCN wrapper; raw GHCN station ids; no EVAP/open_water_evaporation.',
    ('MX', 'ghcnd', 'daily'): 'Thin shared GHCN wrapper; raw GHCN station ids; no EVAP/open_water_evaporation.',
    ...
    ('NO', 'ghcnd', 'daily'): 'Thin shared GHCN wrapper; raw GHCN station ids; no EVAP/open_water_evaporation.',
    ('NZ', 'ghcnd', 'daily'): 'Thin shared GHCN wrapper; raw GHCN station ids; no EVAP/open_water_evaporation.',
    ...
    ('SE', 'ghcnd', 'daily'): 'Mapped-prefix GHCN wrapper using raw GHCN station ids with prefix SW; no EVAP/open_water_evaporation.',
    ('SK', 'ghcnd', 'daily'): 'Mapped-prefix GHCN wrapper using raw GHCN station ids with prefix LO; no EVAP/open_water_evaporation.',
