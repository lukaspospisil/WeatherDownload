...
NOTES: dict[tuple[str, str, str], str] = {
    ...
    ('PT', 'ipma', '1hour'): 'Official IPMA recent hourly station observations; station_id is IPMA idEstacao; timestamps are parsed as naive because the source keys do not include a timezone suffix; observed-only with tas_mean, precipitation, wind_speed, and relative_humidity; pressure is intentionally not mapped; no derived values; not FAO-ready.',
