...
NOTES: dict[tuple[str, str, str], str] = {
    ('AT', 'historical', 'daily'): 'Single public provider for AT.',
    ('AT', 'historical', '1hour'): 'Single public provider for AT.',
    ('AT', 'historical', '10min'): 'Single public provider for AT.',
    ...
    ('CH', 'historical', 'daily'): 'FAO reference evaporation exists on MeteoSwiss metadata but is intentionally not mapped to open_water_evaporation.',
    ...
    ('DE', 'historical', 'daily'): 'Single public provider for DE.',
    ('DE', 'historical', '1hour'): 'Single public provider for DE.',
    ('DE', 'historical', '10min'): 'Single public provider for DE.',
    ('DK', 'historical', 'daily'): 'Single public provider for DK.',
    ('DK', 'historical', '1hour'): 'Single public provider for DK.',
    ...
    ('SE', 'historical', 'daily'): 'Corrected-archive excludes latest three months.',
